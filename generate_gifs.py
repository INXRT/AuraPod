...
def generate_rf_wave_gif():
    ...
    frames[0].save('assets/rf-wavefront-focus.gif', save_all=True, append_images=frames[1:], duration=75, loop=0)
    print("Saved assets/rf-wavefront-focus.gif")
...
def generate_deadline_gif():
    ...
    frames[0].save('assets/deadline-simulator.gif', save_all=True, append_images=frames[1:], duration=90, loop=0)
    print("Saved assets/deadline-simulator.gif")
...
def generate_edition_anatomy_gif():
    ...
    frames[0].save('assets/edition-anatomy-radar.gif', save_all=True, append_images=frames[1:], duration=90, loop=0)
    print("Saved assets/edition-anatomy-radar.gif")

...
export interface KineticTextRevealProps extends Omit<
...
function splitIntoGraphemes(value: string): string[] {
  if (typeof Intl !== "undefined" && "Segmenter" in Intl) {
    const segmenter = new (Intl as unknown as { Segmenter: new (locales: string, options: { granularity: string }) => { segment: (val: string) => Iterable<{ segment: string }> } }).Segmenter("en", { granularity: "grapheme" });
